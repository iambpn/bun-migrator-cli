...
func InitCli(migrator *migrate.Migrator, osArgs []string, extendCli ...*cli.Command) {
	app := &cli.App{
		Name:      "migrator",
		Usage:     "Bun Migration CLI Tool",
		UsageText: "migrator [command]",
		Commands:  getCommands(migrator, extendCli...),
	}
...
func getCommands(migrator *migrate.Migrator, extendCli ...*cli.Command) []*cli.Command {
	...
	return append(commands, extendCli...)
}
